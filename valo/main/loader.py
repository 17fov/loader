...
vers = 5
os.system("cls")
ctypes.windll.kernel32.SetConsoleTitleW("17.fov | #1 valorant tb")
...
if os.path.exists(file):
    ...
    open(file, 'a').close()
    discord_url = "https://discord.gg/AnuRBuyWYq"
